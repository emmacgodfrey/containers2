...
class NormalizedStr:
    ...
    are equal *semantically*, but not equal *representationally*.
    ...
    def __str__(self):
        '''
        This functions converts the NormalizedStr into a regular
        string object. The output is similar, but not exactly the
    ...
    def __add__(self, b):
        ...
        to stay normalized. Therefore, you must renormalize the
        strings after adding them together.
        '''
        string_a = unicodedata.normalize(self.normal_form,
                                         self.text.__str__())
        string_b = unicodedata.normalize(self.normal_form,
                                         b.__str__())
    ...
    def __iter__(self):
        ...
        '''
        return NormalizedStrIter(self.__str__(), self.__len__())
